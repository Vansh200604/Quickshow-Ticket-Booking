    ...
    <div className="fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5">
      ...
      <div
        className={`
          ...
          max-md:font-medium max-md:text-lg max-md:justify-center
      ...
      >
        ...
        <NavLink onClick={() => {scrollTo(0,0); setIsOpen(!isOpen)}} to="/" className={({isActive}) => `hover:underline ${isActive ? 'text-white-700 underline' : ''}`}>Home</NavLink>
