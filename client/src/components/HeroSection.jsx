    ...
    return (
        ...
        bg-cover bg-center h-screen'>
            ...
            <p className='max-w-md text-gray-300'>
                ...
                two people meet in London and try to stop a conspirancy.
            </p>

            <button onClick={() => navigate('/movies')} className='flex items-center gap-1 px-6 py-3 text-sm bg-primary hover:bg-primary-dull
             transition rounded-full font-medium cursor-pointer hover:shadow-lg hover:shadow-white hover:scale-105'>
                Explore Movies
