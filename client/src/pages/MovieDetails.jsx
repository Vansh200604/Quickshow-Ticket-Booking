    ...
    return show && show.movie ? (
        <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-35'>
            ...
            <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
                ...
                <img src={show.movie.poster_path} alt="" className='max-md:mx-auto rounded-xl h-104 max-w-70 
                object-cover' />
                ...
                <div className='relative flex  flex-col gap-3'>
                    ...
                    <div className='flex items-center flex-wrap gap-4 mt-4'>
                        ...
                        <button className='bg-gray-700 p-2.5 rounded-full transition cursor-pointer hover:bg-gray-800 hover:scale-95'>
                            <HeartIcon className='w-5 h-5 hover:scale-105'/>
                        </button>
                    </div>
